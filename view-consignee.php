...
<style>
  ...
  <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> View Category</h1>
        </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="row col-md-12  p-0 m-0">
                ...
                <a href="add-consignee.php" class="btn btn-info mb-2">Add Consignee</a>
                </div>
              </div>
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                ?>
                  <tr>
                    ...
                    <td><?=$valsql['gstin']?></td>
                    <td><?=$valsql['state']?></td>
                    <td><?=$valsql['address1']." ".$valsql['address2']?></td>
                    <td><?=$valsql['place']?></td>
                    <td><?=$valsql['pincode']?></td>
                    <td>
                      <div class="row col-md-12">
                      <div class="col-6 text-left">
                      <a class="btn btn-info btn-sm edit" href="add-consignee.php?id=<?=$valsql['id']?>">
                          <i class="fa fa-pencil delete"></i></a>
                          </div>
                          <div class="col-6">
                               <form method="post">
                         <input type="hidden" value="<?=isset($valsql['id']) ? $valsql['id'] : "";?>" name="deleteid" /> 
                         <button class="btn btn-danger btn-sm edit" type='submit' name='deleteConsignee' href="">
...
<?php
if(isset($_POST['deleteConsignee'])) {
  $deletid=$_POST['deleteid'];
  $delsql = "delete from consignee where id='$deletid'";
