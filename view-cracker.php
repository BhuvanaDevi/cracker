...
<style>
  ...
  <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> View Carackers</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">View</li>
          <li class="breadcrumb-item active"><a href="#">Crackers</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="row col-md-12 p-0 m-0">
                ...
                <a href="add-cracker.php" class="btn btn-info mb-2">Add Cracker</a>
                </div>
              </div>
              ...
              <?php
                ...
                ?>
                   <tr>
                    ...
                    <td><?=$valsql['rate']?></td>
                    <td><?=$valsql['per']?></td>
                    <td><?=$valsql['casecontents']?></td>
                    <td>
                      <div class="row col-md-12">
                      <div class="col-6 text-left">
                        <a class="btn btn-info btn-sm edit" href="add-cracker.php?id=<?=$valsql['id']?>">
                          <i class="fa fa-pencil delete"></i></a>
                      </div>
                      <div class="col-6">
                          <form method="post">
                         <input type="hidden" value="<?=isset($valsql['id']) ? $valsql['id'] : "";?>" name="deleteid" /> 
                         <button class="btn btn-danger btn-sm edit" type='submit' name='deleteCracker' href="">
...
<?php
if(isset($_POST['deleteCracker'])) {
  $deletid=$_POST['deleteid'];
  $delsql = "delete from cracker where id='$deletid'";
