    ...
    $(document).ready(function() {
      $('#qty,#rate,#discount').change(function() {
        ...
        if (dis != '') {
          ...
          $('#taxable_value').val(Math.round(good_value - discount));
      ...
      $('#carton,#carton_contents').change(function() {
        var vals = this.value;
        ...
        $('#total_carton').val(contentss);
        var qty = parseInt(vals) * parseInt(contentss);
        $('#qty').val(qty);
        var rate = $('#rate').val();
        var amt = qty * rate;
        $('#amount').val(amt);
      ...
      <div class="tile">
        <div class="tile-body">
          <div class="row form-group col-md-12">
            <div class="col-md-12 text-right"><button class="btn btn-success">Add</button></div>
            <div class="form-group col-md-2">
