                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="col-12 text-left">
                        <a class="btn btn-info btn-sm edit" href="add-category.php?id=<?=isset($valsql['id'])?$valsql['id']:""?>">
                          <i class="fa fa-pencil delete"></i></a>
                         <form method="post">
                         <input type="hidden" value="<?=isset($valsql['id']) ? $valsql['id'] : "";?>" name="deleteid" /> 
                         <button class="btn btn-danger btn-sm edit" type='submit' name='deleteCategory' href="">
...
if(isset($_POST['deleteCategory'])) {
  ...
  $delsql = "delete from category where id='$deletid'";
